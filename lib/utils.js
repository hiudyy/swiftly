...
export const buildQueryString = (params) => {
    ...
    for (const [key, value] of Object.entries(params || {})) {
        // Arrays pass through so querystring.stringify emits repeated keys
        // (`tags=a&tags=b`), matching axios/got conventions. Nested plain
        // objects are JSON-serialized because querystring.stringify would
        // otherwise drop them (`o=`); arrays are handled natively.
